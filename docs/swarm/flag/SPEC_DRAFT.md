...
## Acceptance Criteria
- [ ] Boolean flags work (on/off)
- [ ] Percentage rollouts work with consistent hash
- [ ] User targeting works (specific users always get flag)
- [ ] In-code flags supported
- [ ] Database flags supported
- [ ] Server-side evaluation works
- [ ] Client-side evaluation works
- [ ] Environment-driven adapter selection
- [ ] Can be installed via `npm install @cyguin/flag`
